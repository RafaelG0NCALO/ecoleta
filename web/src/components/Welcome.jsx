...
export default function Welcome({ userData }) {
  ...
  const hasLocalRegistered =  userData.conta === 2 ? local.local && local.local.length > 0 : '';
  ...
  return (
    <div className='w-full flex items-center justify-between max-md:flex-wrap gap-5 pt-6'>
      ...
      <div className='flex justify-end w-full max-sm:flex-wrap gap-5'>
        {userType === 'user' ? (
          <>
          ...
          {hasLocalRegistered ? 
          <>
           <Link to='/editar-ponto-de-coleta' className='bg-[#34CB79] max-md:w-full flex justify-between overflow-hidden items-center h-12 rounded-md text-white'>
           <div className='h-full min-w-14 bg-[#2FB86E] flex items-center justify-center'>
             <MapPin />
           </div>
           <div className='text-white px-4 w-full text-center'>
          ...
          :
            ...
            <Link to='/editar-dados-de-coleta' className='bg-[#34CB79] max-md:w-full flex justify-between overflow-hidden items-center h-12 rounded-md text-white'>
           <div className='h-full min-w-14 bg-[#2FB86E] flex items-center justify-center'>
             <Cog />
           </div>
           <div className='text-white px-4 w-full text-center'>
